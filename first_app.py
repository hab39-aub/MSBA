...
volc = 'https://aw.githubusercontent.com/hab39-aub/MSBA/blob/master/volcano_data_2010.csv'
@st.cache
def load_data(nrows):
    data = pd.read_csv(volc, nrows=nrows, error_bad_lines=False,index_col=0)
    return data
